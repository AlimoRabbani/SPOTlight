...
class RPi:
    ...
    def read_temperature():
        while True:
            data = RPi.bus.read_word_data(int(Config.config["RPi_ADC_ADDRESS"], 16), int(Config.config["RPi_TMP_CMD"], 16))
    ...
    def read_motion():
        ...
        while True:
            ...
            data = RPi.bus.read_word_data(int(Config.config["RPi_ADC_ADDRESS"], 16), int(Config.config["RPi_MOTION_CMD"], 16))
